...
import profilePic from "../../public/images/2.png";
      ...
      <Layout className='pt-16'>
        ...
        <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2  md:col-span-8">
                ...
                <p className="font-medium">Hi, Im Thejas B M, a web developer and UI/UX designer with a passion for creating beautiful, functional, 
...
<p className="font-medium">Whether Im working on a website, mobile app, or 
