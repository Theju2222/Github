       ...
       <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
        ...
        <button className="flex-col justify-center items-center hidden lg:flex" onClick={handleClick}>
           ...
           <nav>
                ...
                <CustomLink href="/webdevelopment" title="Web Development" className="mx-4"/>
                <CustomLink href="/appdevelopment" title="App Development" className="ml-4"/>
            </nav>
           
            <nav className="flex items-center justify-center flex-wrap">
                {/* <motion.a href="/" target={"_blank"} whileHover={{y:-2 }} whileTap={{scale:0.9}} className="w-6 mr-3"><TwitterIcon/></motion.a> */}
                <motion.a href="https://github.com/Theju2222" target={"_blank"} whileHover={{y:-2 }} whileTap={{scale:0.9}} className="w-6 mx-3"><GithubIcon/></motion.a>
           ...
           </div>
{
    ...
    <nav className="flex items-center flex-col justify-center">
         ...
         <CustomMobileLink href="/webdevelopment" title="Web Development" className="" toggle={handleClick}/>
         <CustomMobileLink href="/appdevelopment" title="App Development" className="" toggle={handleClick}/>
     </nav>
     ...
     <nav className="flex items-center justify-center flex-wrap mt-2">
         ...
         <motion.a href="https://github.com/Theju2222" target={"_blank"} whileHover={{y:-2 }} whileTap={{scale:0.9}} className="w-6 mx-3 bg-light rounded-full dark:bg-dark sm:mx-1"><GithubIcon/></motion.a>
